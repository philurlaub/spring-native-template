...
* The original package name 'de.philipp-paul.native' is invalid and this project uses 'com.example.demo' instead.

# Getting Started

```
docker run --name metadata-postgres -e POSTGRES_PASSWORD=postgres -d postgres
```
